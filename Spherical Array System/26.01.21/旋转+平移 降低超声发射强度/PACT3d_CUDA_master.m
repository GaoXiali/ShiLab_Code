...
folder_path = 'I:\GXL\球阵系统\26.01.21\旋转+平移 降低超声发射强度\';
fixMatlabFilenames(folder_path);%自动校正错误文件名
str_name = dir(fullfile(folder_path, '*_0.mat'));
[datax,DAQ_time_point] = func_3D_PACT_Data_Time_Read(folder_path,str_name(277).name);
...
T = 22.8; % 水温
V_M = 1510.5;
V_M_Range = 1500:0.5:1540; % 单声速迭代范围

% VM_out = waterSoundSpeed(T); % 外声速（水），单位 m/s 
VM_out = 1514.5; % 外声速（水），单位 m/s  
VM_out_Range = 1475:0.5:1499; % 外声速迭代范围
VM_in = 1514.5; % 内声速，单位 m/s  
