...
% 椭球面位置需根据实验情况进行调整
%
% Author：Xiali Gao  Version：3.1  2026.1.14
%
% *************************************************************************
...
folder_path = 'I:\GXL\球阵系统\26.01.07\旋转+平移2\';
...
T = 22.8; % 水温
V_M = 1524.5;
V_M_Range = 1520:0.5:1530; % 单声速迭代范围
...
switch reconstruct_mode
    ...
    case 10 %单/双声速旋转平移复合
        ...
        Nframex = 9; %x方向扫描次数
        Nframey = 11;%floor(Ndata/Nframex); %y方向扫描次数
        ...
        %%
                ...
                for frame = 1:1:static_Nframe %注意这里的step*delta_angle为相邻复合角
                    ...
                    % 归一化并应用非线性增强
                    pa_img2 = pa_img1./total_angle_weight;
                    [GaussianMask, ~, ~] = generateGaussianMask({x_range, y_range}, 'Center', [5,2], 'Sigma', 10);
                    GaussianMask = GaussianMask.*ones(1,1,size(z_range,2));%z方向均匀
                    pa_img3 = pa_img2.*GaussianMask;
